...
| <a href="#color" id="color"><code>--color</code></a>                                                              | Colorize debug output (the HTTP response output is not colorized).<br><br>Environment variables: HURL_COLOR<br><br>This is a cli-only option.<br>                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| <a href="#no-color" id="no-color"><code>--no-color</code></a>                                                     | Do not colorize output.<br><br>Environment variables: HURL_NO_COLOR, NO_COLOR<br><br>This is a cli-only option.<br>                                                                                                                                                                                                                                                                                                                                                                                                                                      |
