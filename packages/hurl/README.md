...
| <a href="#negotiate" id="negotiate"><code>--negotiate</code></a>                                                  | Tell Hurl to use Negotiate (SPNEGO) authentication.<br><br>This is a cli-only option.<br>                                                                                                                                                                                                                                                                                                                                            |
...
| <a href="#ntlm" id="ntlm"><code>--ntlm</code></a>                                                                 | Tell Hurl to use NTLM authentication<br><br>This is a cli-only option.<br>                                                                                                                                                                                                                                                                                                                                                           |
