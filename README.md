...
<div class="home-html-report">
    <img class="light-img u-drop-shadow u-border" src="/docs/assets/img/home-waterfall-light.png#gh-light-mode-only" width="480" alt="HTML report"/>
    <img class="dark-img u-drop-shadow u-border" src="/docs/assets/img/home-waterfall-dark.png#gh-dark-mode-only" width="480" alt="HTML report"/>
</div>
