...
| <a href="#no-header" id="no-header"><code>--no-header &lt;NAME&gt;</code></a>                                     | Remove a header from information sent. Can be used several times in a command.<br><br>This is a cli-only option.<br>                                                                                                                                                                                                                                                                                                          |
