...
| <a href="#fail-with-body" id="fail-with-body"><code>--fail-with-body</code></a>          | Output body response on standard output if there are any errors. By default, Hurl outputs the last body response on standard output only when a run is successful.<br><br>This is a cli-only option.<br>                                                                                                                                                                                                                              |
